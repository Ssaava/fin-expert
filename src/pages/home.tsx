...
const Home = () => {
  return (
    <>
      <div className="px-4 md:px-10 min-h-screen pt-28 md:pt-48">
        <div className="max-w-[60rem]  mx-auto w-full flex flex-col gap-6">
          ...
          <Button className="rounded-full bg-primary-500 text-lg w-fit mx-auto py-6 !px-8 font-bold text-white">
