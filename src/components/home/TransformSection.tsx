      ...
      <section className="px-4 md:px-10  min-h-screen mt-8 lg:mt-0">
        <div className="bg-primary-100 px-4 md:px-16 xl:px-56 py-10 md:py-16 rounded-3xl flex flex-col gap-16">
          ...
          <div className="grid sm:grid-cols-2 gap-4 lg:gap-8 ">
            <div className="flex flex-col gap-4">
              <div className="group rounded-lg p-4 md:p-10 flex flex-col gap-6 max-w-[30rem] sm:ml-auto bg-yellow-100 hover:bg-yellow-400 duration-700">
                ...
                <h3 className="font-bold text-3xl">Clear inclusivity scores</h3>
                <p className="text-black/60">
                  No more guesswork; get accurate inclusivity scores that reveal
            ...
            <div className="flex flex-col gap-4">
              <div className="group rounded-lg p-4 md:p-10 flex flex-col gap-6 max-w-[30rem] sm:mr-auto bg-pink-100 hover:bg-white duration-700">
              ...
              <div className="group rounded-lg p-4 md:p-10 flex flex-col gap-6 max-w-[30rem] sm:mr-auto bg-white hover:bg-[#0000000A] duration-700">
